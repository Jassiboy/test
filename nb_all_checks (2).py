    ...
    def check_file_count(self, path: str, regex: str) -> ValidationResult:
        ...
        try:
            ...
            return ValidationResult(
                "FILE_COUNT_CHECK",
                "PASS",
                f"{count} file(s) found matching regex '{regex}'"
            )
        ...
        try:
            ...
            if count != expected:
                return ValidationResult(
                    "EXPECTED_FILE_COUNT_CHECK",
                    "FAIL",
                    f"There were {expected} file were expected but received '{count}' in path '{path}'"
                )
        ...
        try:
            ...
            return ValidationResult(
                ...
                (
                    ...
                    f"are within the expected size range [{min_size}, {max_size}] bytes "
                )
            )
        ...
        try:
            ...
            if duplicates:
                ...
                return ValidationResult(
                    ...
                    "FAIL",
                    (
                        f"Duplicate files detected in path '{path}': "
                        f"{duplicate_details}"
                    )
                )
            ...
            return ValidationResult(
                ...
                "PASS",
                (
                    f"No duplicate files found for files matching "
